...
<body>
    ...
    <div class="contendor-img-login">
        ...
        <div class="centro" style="margin-top: 2rem;  width: 100%;">
            ...
            <!--<div class="dr panel">
                ...
                <a href="logout.php" title="Cerrar sesion" class="directo">
    ...
    <div class="centro logos">
            ...
            <figure class="figure"><a href="/es/" title="Universidad Surcolombiana"><img src="https://www.usco.edu.co/imagen-institucional/ocre/universidad-surcolombiana.png" id="idLogo" name="idLogo" alt="Universidad Surcolombiana" /></a></figure>
            <figure class="figure" style="display: inline-block;"><img src="resources/images/republica-de-colombia.png" id="idEscudo" name="idEscudo" alt="República de Colombia" title="República de Colombia" /></figure>
    ...
    <!--
<div class="all menu2do">
    <div class="centro">
        <nav>
            <ul>
                
                     <li><a href="/es/mipg/" target="_self" title="Adopción Modelo Integrado de Planeación y Gestión">Adopción Modelo Integrado de Planeación y Gestión</a></li>
                
                     <li><a href="/es/plan-anticorrupcion" target="_self" title="Plan Anticorrupción">Plan Anticorrupción</a></li>
                
                     <li><a href="https://gaitana.usco.edu.co/generar_facturas/solicitud_liqui.php" target="_blank" title="Comprobante de Pago">Comprobante de Pago</a></li>
                
                     <li><a href="https://quinchana.usco.edu.co/proveedores" target="_self" title="Proveedores">Proveedores</a></li>
                
                     <li><a href="https://quinchana.usco.edu.co/contratacion/procesoPublicaciones" target="_blank" title="Contratación">Contratación</a></li>
                
                     <li><a href="/es/transparencia-y-acceso-a-la-informacion-publica" target="_self" title="Acceso a la Información Pública">Acceso a la Información Pública</a></li>
                
                     <li><a href="https://campusvirtual.usco.edu.co/campusvirtual/" target="_blank" title="Campus Virtual">Campus Virtual</a></li>
